...
# Define score ranges based on standard_test_B.md
# below2: 0~9
# below1: 10~11
# on: 12~15
# above1: 16~17
...
boundaries = [9.5, 11.5, 15.5, 17.5] # Approximate boundaries for visual separation
for b in boundaries:
    ax1.axvline(b, color='gray', linestyle='--', alpha=0.5)

ax1.set_title('레벨별 점수 정규분포 비교')
...
plt.suptitle('2024년 5월 레벨별 학생 성적 분석 (Standard B)', fontsize=16)
plt.tight_layout()
plt.savefig('standard_B_analysis.png', dpi=300)
print("Analysis complete. Image saved as 'standard_B_analysis.png'.")
