...
# Define score ranges based on standard_test_A.md
# below2: 0~6
# below1: 7~11
# on: 12~15
# above1: 16~17
...
ax1.set_title('레벨별 점수 정규분포 비교 (Standard A)')
...
ax2.set_title('레벨별 구간 분류 학생 수 (Standard A)')
...
plt.suptitle('2024년 5월 레벨별 학생 성적 분석 (Standard A)', fontsize=16)
plt.tight_layout()
plt.savefig('standard_A_analysis.png', dpi=300)
print("Analysis complete. Image saved as 'standard_A_analysis.png'.")
