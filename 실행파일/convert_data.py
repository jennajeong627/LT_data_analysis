...
source_file = os.path.join(base_dir, "raw_data", "2025년_11월_Gr2_LT_문항데이터_v3.xlsx")
dest_dir = os.path.join(base_dir, "2025_11월_data")
dest_file = os.path.join(dest_dir, "2025_11월_GT2.csv")
